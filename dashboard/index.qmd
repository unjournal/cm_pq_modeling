...
function simulate(n, seed, params) {
  ...
  // Price ($/g) - UPDATED to reflect realistic ranges
  // "Cheap" = scaled recombinant production achieved (industry target)
  // "Expensive" = limited progress from current prices
  const price_recf_cheap = sampleLognormalP5P95(rng, 1.0, 100.0, n);   // Scaled production: $1-100/g
  const price_recf_exp = sampleLognormalP5P95(rng, 500.0, 50000.0, n); // Limited progress: $500-50,000/g
