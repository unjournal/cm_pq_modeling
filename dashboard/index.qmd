...
::: {.callout-note}
**New to this model?** Start with the [Simplest Model →](simple.qmd) — a shorter version focusing on some key levers with line-of-sight explanations. You can carry your settings over to this Advanced Model when you're ready.
:::
