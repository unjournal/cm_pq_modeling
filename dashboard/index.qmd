...
*A [Squiggle reference model](../models/cm_cost_v0.2.squiggle) is maintained with equivalent parameters. The SquiggleHub version may differ; this dashboard and the local `.squiggle` file are kept in sync.*
:::
