...
This model was largely AI-generated. While we aimed to ground parameter ranges in published TEAs, **we have not yet systematically verified that every hardcoded range in the simulation code traces to a specific source.** Some ranges (particularly for micronutrients, media turnover, and growth factor quantities) may reflect AI-synthesized estimates rather than direct citations. This is one reason we are seeking expert review. The parameter-specific source claims in the expandable details under each slider should be treated as "intended sources" pending verification.
:::
...
| [GFI amino acid report (2025)](https://gfi.org/resource/amino-acid-cost-and-supply-chain-analysis-for-cultivated-meat/) | Evidence that Humbird AA prices overestimated 2-10x | Context for parameter ranges; not yet directly incorporated into model values |
