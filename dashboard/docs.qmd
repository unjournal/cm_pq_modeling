...
| 2a | **[Media](#variable-operating-costs-voc)** | (1000/density) × turnover × $/L | density (g/L), turnover, $/L |
...
**Media-use assumptions** from the same report and the cell-density/turnover math on the main page:
...
| 60 L/kg (less-optimized, e.g. 30 g/L density × 2× turnover) | ≈0.00612 |
