...
Comment directly on this page using [Hypothesis](https://hypothes.is/) — click the `<` tab on the right edge. Highlight any equation, parameter, or explanation to annotate it. We aim to respond to all comments.

For longer-form questions, corrections, methodology debates, or alternative-source suggestions, post in the **[🧠 Substantive discussion hub →](https://github.com/unjournal/cm_pq_modeling/discussions/3)** — the unified home for bio / econ / stats / engineering / welfare debate. See the [📖 full Discussion Map](discuss.html) for domain-organized sub-threads.
:::
...
| 2 | **[VOC](#variable-operating-costs-voc)** | VOC = Media + Micros + GFs + Other | — |
...
### Micronutrient Costs {#micronutrient-costs}
...
|-------|------------------|-------------|-------------------|--------|
| Pharma-grade | 1.0 – 10.0 | $0.50 – $20 | $0.50 – $200 | [Sigma-Aldrich catalog pricing](https://www.sigmaaldrich.com/) |
| Food-grade | 0.1 – 2.0 | $0.02 – $2 | $0.002 – $4 | Commodity vitamin suppliers |

**Why the 90% cost reduction?** Pharma-grade micronutrients require:
- Ultra-high purity (>99.9%) with certificates of analysis
- Controlled manufacturing environments (GMP)
...
|----------|----------------|-------------|-------------------|--------|
| **Scalable tech achieved** | 0.0001 – 0.005 | $1 – $100 | At least one breakthrough reaches commercial scale | [GFI 2024 targets](https://gfi.org/resource/cultivated-meat-growth-factor-volume-and-cost-analysis/) |
| **Limited progress** | 0.0005 – 0.02 | $500 – $50,000 | Incremental improvements only; no step-change | [Current research prices](https://cen.acs.org/food/Inside-effort-cut-cost-cultivated/101/i33) |
