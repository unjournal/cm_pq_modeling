...
See our [TEA comparison page](compare.qmd) for how this compares to published TEA figures, which often differ in output basis (hybrid products, dry weight, retail price).
:::
