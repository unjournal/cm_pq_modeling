...
| [Food-grade micronutrients](#micronutrient-costs) | 65% | 0.20 | Reduces micronutrient $/g by ~90% | <abbr title="Food-safe vitamins, minerals, and trace elements sourced from supplement/feed supply chains rather than pharmaceutical suppliers">Commodity vitamins/minerals</abbr> vs. pharma-grade |
| [Scalable GF technology](learn.qmd#growth-factors-the-pivotal-challenge) | 50% | 0.25 | Switches to "cheap" GF prices ([see price tables](#gf-scenarios)) | Any breakthrough: autocrine, plant farming, precision fermentation. See [binary toggle rationale](#the-binary-cheap-vs-expensive-toggle) |
...
| Scale exponent | 0.6–0.9 | Economies of scale power (how much CAPEX grows as plant capacity increases) | $s$ in CAPEX = CAPEX$_{\text{ref}} \times (Q/Q_{\text{ref}})^s$ — see [above](#economies-of-scale-the-k-sim-qs-relationship). This is the exponent $r$ referenced in the "CAPEX scaling" section header. |
