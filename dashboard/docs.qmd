...
**How the reference scale is used:** We define "CAPEX at 20 kTA" as our baseline, then scale up or down using the [economies of scale formula below](#economies-of-scale-the-k-sim-qs-relationship). This is standard practice in chemical engineering cost estimation.
...
| Scale exponent | 0.6–0.9 | Economies of scale power | $s$ in CAPEX = CAPEX$_{\text{ref}} \times (Q/Q_{\text{ref}})^s$ — see [above](#economies-of-scale-the-k-sim-qs-relationship) |
