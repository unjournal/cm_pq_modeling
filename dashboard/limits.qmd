...
subtitle: "An external methodological review — what the model gets right, what it doesn't, and what we're doing about it"
---

::: {.callout-note}
This review was conducted in early 2026 based on the model and form as they existed at that time. Both have since been updated — some issues below are already addressed; others are work in progress. The full source report is on GitHub: [CM_model_deep-research-report.md](https://github.com/unjournal/cm_pq_modeling/blob/main/critique_discussion/CM_model_deep-research-report.md).
:::
...
We agree. This model is designed to support structured exploration and deliberation — not to produce a single authoritative posterior. The limitations below are real, and we name them rather than paper over them.
